...
const InstallationsHistory = () => {
    ...
    useEffect(() => {
        const getClaims = async () => {
            const response = await api.get(apiRoutes.installations.getAll);
    ...
    const columns = [
        ...
        { field: 'news', headerName: 'Novedades', width: 450 },
        {
            field: 'line_number',
        ...
        { field: 'status', headerName: 'Estado', width: 120 },
        {
            ...
            headerName: 'Fecha',
            width: 250,
            valueGetter: (value, row) => dayjs(row.createdAt).format('DD-MM-YYYY'),
        },
        {
            field: 'actions',
            headerName: 'Actions',
    ...
    return (
        <Box sx={{ width: '100%' }}>
            <Typography variant='h5'>Historial de instalaciones</Typography>
            <DataGrid
                rows={installations}
                columns={columns}
                initialState={{
